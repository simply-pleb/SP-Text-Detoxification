...
def download_wieting_similarity_model():
    # Download the ZIP file
    subprocess.run(["wget", "https://storage.yandexcloud.net/nlp/wieting_similarity_data.zip"])

    # Define the destination folder
    destination_folder = "models/sim"

    # Unzip the downloaded file to the specified destination folder
    subprocess.run(["unzip", "wieting_similarity_data.zip", "-d", destination_folder])
...
if __name__ == "__main__":
    ...
    # similarity
    # download_wieting_similarity_model()
